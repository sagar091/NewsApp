...
public class ActivityNewsDetailsBindingImpl extends ActivityNewsDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txtReadMore, 4);
        sViewsWithIds.put(R.id.fabSaveArticle, 5);
    }
    // views
    @NonNull
    ...
    public ActivityNewsDetailsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityNewsDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.example.newsapp.utility.BindingAdapters.setVisibility(this.txtNewsContent, modelDescription);
